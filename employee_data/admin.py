...
from employee_data.models import Basic_Information

# Register your models here.
class Basic_Information_Admin(admin.ModelAdmin):
    fieldsets = [
...
admin.site.register(Basic_Information, Basic_Information_Admin)
